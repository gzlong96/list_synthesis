...
def main():
    ...
    model = Rubustfill(args.nb_inputs, args.E, max_token_length, batch_size=64, K=128, attention=None, lr=5e-4)
    for i in range(args.epochs//10):
        model.fit(rows_type, rows_val, y, epochs=10, validation_split=args.val_split)
